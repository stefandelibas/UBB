...
//-----------------------------------------------------------------------------------------------------------------------	
		...
		MyIStack<IStmt> exeStack1 = new MyStack<IStmt>();
		  IStmt ex1 = new CompStmt(new AssignStmt("v",new ConstExp(2)), new PrintStmt(new VarExp("v")));
	    	exeStack1.push(ex1);
		 PrgState prg1 = new PrgState(exeStack1,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------	
    	...
    	PrgState prg2 = new PrgState(exeStack2,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------	    	
		...
		PrgState prg3 = new PrgState(exeStack3,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------		
        ...
        PrgState prg4 = new PrgState(exeStack4,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------	    	
		...
		PrgState prg5 = new PrgState(exeStack5,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------	    	
  		...
  		PrgState prg6 = new PrgState(exeStack6,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------	    	
		...
		PrgState prg7 = new PrgState(exeStack7,symTable,out,fileTable,heap,1);
...
//----------------------------------------------------------------------------------------------------------------------- 
		...
		PrgState prg8 = new PrgState(exeStack8,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------	
		...
		MyIStack<IStmt> exeStack9 = new MyStack<IStmt>();
		  IStmt ex9 = new CompStmt(
	    	...
	    	exeStack9.push(ex9);
		 PrgState prg9 = new PrgState(exeStack9,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------	
  		...
  		PrgState prg10 = new PrgState(exeStack10,symTable,out,fileTable,heap,1);
...
//-----------------------------------------------------------------------------------------------------------------------		
        ...
        PrgState prg12 = new PrgState(exeStack12,symTable,out,fileTable,heap,1);
    	Repository repo12 = new Repository(prg12,"log.txt");
...
//-----------------------------------------------------------------------------------------------------------------------	
        ...
        PrgState prg13 = new PrgState(exeStack13,symTable,out,fileTable,heap,1);
    	Repository repo13 = new Repository(prg13,"log.txt");
        Controller ctrl13 = new Controller(repo13);
		IStmt ex13 = new CompStmt(new AssignStmt("v",new ConstExp(10)),
				new CompStmt(new New("a",new ConstExp(22)),
